...
export const appName = "P2T";
export const appSubtitle = "Редактируйте изображения прописывая инструкции, при помощи ИИ.";
export const appMetaDescription = "Редактируйте изображения прописывая инструкции, при помощи ИИ.";
